...
def battle_engine():
    ...
    #hero's turn
        if(battle_action == "1"):
            ...
            print(f"Thou hast struck thine enemy with {game_data.the_hero['weapon']} for {hero_power_hit} damage.")
        ...
        if(enemy_to_fight['hp'] > 0):
            ...
            monster_power_hit = (enemy_to_fight['attack_power'] * enemy_attack_modifier)- game_data.the_hero['defense']
